...
define(function (require, exports, module) {
    var libRes = require('bglibLib/bglib-responses');
    var libEvent = require('bglibLib/bglib-events');
...
// are appended to the packet.
    ...
    bglib.api = {
        ...
        systemReset: {
            header: {
                tType: _bgtechnologyType.Bluetooth,
                mType: _bgmessageType.Command,
                lolen: 1,
                cls: _bgcommandClass.System,
                command: _bgcommandIDs.System_Reset
            }, paramCode: 0x02
        },
        systemHello: {
            header: {
                ...
                lolen: 0,
                cls: _bgcommandClass.System,
                command: _bgcommandIDs.System_Hello
            }, paramCode: 0x00
        },
        systemAddressGet: {
            header: {
                ...
                lolen: 0,
                cls: _bgcommandClass.System,
                command: _bgcommandIDs.System_Address_Get
            }, paramCode: 0x00
        },
        systemRegisterWrite: {
            header: {
                ...
                lolen: 3,
                cls: _bgcommandClass.System,
                command: _bgcommandIDs.System_Reg_Write
            }, paramCode: 0x24
        },
        systemRegisterRead: {
            header: {
                ...
                lolen: 2,
                cls: _bgcommandClass.System,
                command: _bgcommandIDs.System_Reg_Read
            }, paramCode: 0x04
        },
        systemGetCounters: {
            header: {
                ...
                lolen: 0,
                cls: _bgcommandClass.System,
                command: _bgcommandIDs.System_Get_Counters
            }, paramCode: 0x00
        },
        systemGetConnections: {
            header: {
                ...
                lolen: 0,
                cls: _bgcommandClass.System,
                command: _bgcommandIDs.System_Get_Connections
            }, paramCode: 0x00
        },
        systemReadMemory: {
            header: {
                ...
                lolen: 5,
                cls: _bgcommandClass.System,
                command: _bgcommandIDs.System_Read_Memory
            }, paramCode: 0x26
        },
        systemGetInfo: {
            header: {
                ...
                lolen: 0,
                cls: _bgcommandClass.System,
                command: _bgcommandIDs.System_Get_Info
            }, paramCode: 0x00
        },
        systemEndpointTx: {
            header: {
                ...
                lolen: 2,
                cls: _bgcommandClass.System,
                command: _bgcommandIDs.System_Endpoint_Tx
            }, paramCode: 0x82
        },
        systemWhitelistAppend: {
            header: {
                ...
                lolen: 7,
                cls: _bgcommandClass.System,
                command: _bgcommandIDs.System_Whitelist_Append
            }, paramCode: 0x2a
        },
        systemWhitelistRemove: {
            header: {
                ...
                lolen: 7,
                cls: _bgcommandClass.System,
                command: _bgcommandIDs.System_Whitelist_Remove
            }, paramCode: 0x2a
        },
        systemWhiteListClear: {
            header: {
                ...
                lolen: 0,
                cls: _bgcommandClass.System,
                command: _bgcommandIDs.System_Whitelist_Clear
            }, paramCode: 0x00
        },
        systemEndpointRx: {
            header: {
                ...
                lolen: 2,
                cls: _bgcommandClass.System,
                command: _bgcommandIDs.System_Endpoint_Rx
            }, paramCode: 0x22
        },
        ...
        psDefrag: {
            header: {
                ...
                mType: _bgmessageType.Command,
                lolen: 0,
                cls: _bgcommandClass.PersistentStore,
                command: _bgcommandIDs.Flash_PS_Defrag
            }, paramCode: 0x00
        },
        psDump: {
            header: {
                ...
                lolen: 0,
                cls: _bgcommandClass.PersistentStore,
                command: _bgcommandIDs.Flash_PS_Dump
            }, paramCode: 0x00
        },
        psEraseAll: {
            header: {
                ...
                lolen: 0,
                cls: _bgcommandClass.PersistentStore,
                command: _bgcommandIDs.Flash_PS_Erase_All
            }, paramCode: 0x00
        },
        psSave: {
            header: {
                ...
                lolen: 3,
                cls: _bgcommandClass.PersistentStore,
                command: _bgcommandIDs.Flash_PS_Save
            }, paramCode: 0x84
        },
        psLoad: {
            header: {
                ...
                lolen: 2,
                cls: _bgcommandClass.PersistentStore,
                command: _bgcommandIDs.Flash_PS_Load
            }, paramCode: 0x04
        },
        psErase: {
            header: {
                ...
                lolen: 2,
                cls: _bgcommandClass.PersistentStore,
                command: _bgcommandIDs.Flash_PS_Erase
            }, paramCode: 0x04
        },
        flashErasePage: {
            header: {
                ...
                lolen: 1,
                cls: _bgcommandClass.PersistentStore,
                command: _bgcommandIDs.Flash_Erase_Page
            }, paramCode: 0x02
        },
        flashWriteWords: {
            header: {
                ...
                lolen: 3,
                cls: _bgcommandClass.PersistentStore,
                command: _bgcommandIDs.Flash_Write_Words
            }, paramCode: 0x84
        },
        ...
        attributesWrite: {
            header: {
                ...
                mType: _bgmessageType.Command,
                lolen: 4,
                cls: _bgcommandClass.AttributeDatabase,
                command: _bgcommandIDs.Attributes_Write
            }, paramCode: 0x824
        },
        attributesRead: {
            header: {
                ...
                lolen: 4,
                cls: _bgcommandClass.AttributeDatabase,
                command: _bgcommandIDs.Attributes_Read
            }, paramCode: 0x44
        },
        attributesReadType: {
            header: {
                ...
                lolen: 2,
                cls: _bgcommandClass.AttributeDatabase,
                command: _bgcommandIDs.Attributes_Read_Type
            }, paramCode: 0x04
        },
        attributesUserReadResponse: {
            header: {
                ...
                lolen: 3,
                cls: _bgcommandClass.AttributeDatabase,
                command: _bgcommandIDs.Attributes_User_Read_Response
            }, paramCode: 0x822
        },
        attributesUserWriteResponse: {
            header: {
                ...
                lolen: 2,
                cls: _bgcommandClass.AttributeDatabase,
                command: _bgcommandIDs.Attributes_User_Write_Response
            }, paramCode: 0x22
        },
        ...
        connectionDisconnect: {
            header: {
                ...
                mType: _bgmessageType.Command,
                lolen: 1,
                cls: _bgcommandClass.Connection,
                command: _bgcommandIDs.Connection_Disconnect
            }, paramCode: 0x02
        },
        connectionGetRSSI: {
            header: {
                ...
                lolen: 1,
                cls: _bgcommandClass.Connection,
                command: _bgcommandIDs.Connection_Get_RSSI
            }, paramCode: 0x02
        },
        connectionUpdate: {
            header: {
                ...
                lolen: 9,
                cls: _bgcommandClass.Connection,
                command: _bgcommandIDs.Connection_Update
            }, paramCode: 0x44442
        },
        connectionVersion: {
            header: {
                ...
                lolen: 1,
                cls: _bgcommandClass.Connection,
                command: _bgcommandIDs.Connection_Version_Update
            }, paramCode: 0x02
        },
        connectionChannelMapGet: {
            header: {
                ...
                lolen: 1,
                cls: _bgcommandClass.Connection,
                command: _bgcommandIDs.Connection_Channel_Map_Get
            }, paramCode: 0x02
        },
        connectionChannelMapSet: {
            header: {
                ...
                lolen: 2,
                cls: _bgcommandClass.Connection,
                command: _bgcommandIDs.Connection_Channel_Map_Set
            }, paramCode: 0x82
        },
        connectionFeaturesGet: {
            header: {
                ...
                lolen: 1,
                cls: _bgcommandClass.Connection,
                command: _bgcommandIDs.Connection_Features_Get
            }, paramCode: 0x02
        },
        connectionGetStatus: {
            header: {
                ...
                lolen: 1,
                cls: _bgcommandClass.Connection,
                command: _bgcommandIDs.Connection_Get_Status
            }, paramCode: 0x02
        },
        connectionRawTx: {
            header: {
                ...
                lolen: 2,
                cls: _bgcommandClass.Connection,
                command: _bgcommandIDs.Connection_Raw_Tx
            }, paramCode: 0x82
        },
        ...
        attClientFindByTypeValue: {
            header: {
                ...
                mType: _bgmessageType.Command,
                lolen: 8,
                cls: _bgcommandClass.AttributeClient,
                command: _bgcommandIDs.Attclient_Find_By_Type_Value
            }, paramCode: 0x84442
        },
        attClientReadByGroupType: {
            header: {
                ...
                lolen: 6,
                cls: _bgcommandClass.AttributeClient,
                command: _bgcommandIDs.Attclient_Read_By_Group_Type
            }, paramCode: 0x8442
        },
        attClientReadByType: {
            header: {
                ...
                lolen: 6,
                cls: _bgcommandClass.AttributeClient,
                command: _bgcommandIDs.Attclient_Read_By_Type
            }, paramCode: 0x8442
        },
        attClientFindInformation: {
            header: {
                ...
                lolen: 5,
                cls: _bgcommandClass.AttributeClient,
                command: _bgcommandIDs.Attclient_Find_Information
            }, paramCode: 0x442
        },
        attClientReadByHandle: {
            header: {
                ...
                lolen: 3,
                cls: _bgcommandClass.AttributeClient,
                command: _bgcommandIDs.Attclient_Read_By_Handle
            }, paramCode: 0x42
        },
        attClientAttributeWrite: {
            header: {
                ...
                lolen: 4,
                cls: _bgcommandClass.AttributeClient,
                command: _bgcommandIDs.Attclient_Attribute_Write
            }, paramCode: 0x842
        },
        attClientWriteCommand: {
            header: {
                ...
                lolen: 4,
                cls: _bgcommandClass.AttributeClient,
                command: _bgcommandIDs.Attclient_Write_Command
            }, paramCode: 0x842
        },
        attClientIndicateConfirm: {
            header: {
                ...
                lolen: 1,
                cls: _bgcommandClass.AttributeClient,
                command: _bgcommandIDs.Attclient_Indicate_Confirm
            }, paramCode: 0x02
        },
        attClientReadLong: {
            header: {
                ...
                lolen: 3,
                cls: _bgcommandClass.AttributeClient,
                command: _bgcommandIDs.Attclient_Read_Long
            }, paramCode: 0x42
        },
        attClientPrepareWrite: {
            header: {
                ...
                lolen: 6,
                cls: _bgcommandClass.AttributeClient,
                command: _bgcommandIDs.Attclient_Prepare_Write
            }, paramCode: 0x8442
        },
        attClientExecuteWrite: {
            header: {
                ...
                lolen: 2,
                cls: _bgcommandClass.AttributeClient,
                command: _bgcommandIDs.Attclient_Execute_Write
            }, paramCode: 0x22
        },
        attClientReadMultiple: {
            header: {
                ...
                lolen: 2,
                cls: _bgcommandClass.AttributeClient,
                command: _bgcommandIDs.Attclient_Read_Multiple
            }, paramCode: 0x82
        },
        ...
        smEncryptStart: {
            header: {
                ...
                mType: _bgmessageType.Command,
                lolen: 2,
                cls: _bgcommandClass.SecurityManager,
                command: _bgcommandIDs.SM_Encrypt_Start
            }, paramCode: 0x22
        },
        smSetBondableMode: {
            header: {
                ...
                lolen: 1,
                cls: _bgcommandClass.SecurityManager,
                command: _bgcommandIDs.SM_Set_Bondable_Mode
            }, paramCode: 0x02
        },
        smDeleteBonding: {
            header: {
                ...
                lolen: 1,
                cls: _bgcommandClass.SecurityManager,
                command: _bgcommandIDs.SM_Delete_Bonding
            }, paramCode: 0x02
        },
        smSetParameters: {
            header: {
                ...
                lolen: 3,
                cls: _bgcommandClass.SecurityManager,
                command: _bgcommandIDs.SM_Set_Parameters
            }, paramCode: 0x222
        },
        smPasskeyEntry: {
            header: {
                ...
                lolen: 5,
                cls: _bgcommandClass.SecurityManager,
                command: _bgcommandIDs.SM_Passkey_Entry
            }, paramCode: 0x62
        },
        smGetBonds: {
            header: {
                ...
                lolen: 0,
                cls: _bgcommandClass.SecurityManager,
                command: _bgcommandIDs.SM_Get_Bonds
            }, paramCode: 0x00
        },
        smSetOOBData: {
            header: {
                ...
                lolen: 1,
                cls: _bgcommandClass.SecurityManager,
                command: _bgcommandIDs.SM_Set_OOB_Data
            }, paramCode: 0x08
        },
        ...
        gapSetPrivacyFlags: {
            header: {
                ...
                mType: _bgmessageType.Command,
                lolen: 2,
                cls: _bgcommandClass.GenericAccessProfile,
                command: _bgcommandIDs.GAP_Set_Privacy_Flags
            }, paramCode: 0x22
        },
        gapSetMode: {
            header: {
                ...
                lolen: 2,
                cls: _bgcommandClass.GenericAccessProfile,
                command: _bgcommandIDs.GAP_Set_Mode
            }, paramCode: 0x22
        },
        gapDiscover: {
            header: {
                ...
                lolen: 1,
                cls: _bgcommandClass.GenericAccessProfile,
                command: _bgcommandIDs.GAP_Discover
            }, paramCode: 0x02
        },
        gapConnectDirect: {
            header: {
                ...
                lolen: 0xf,
                cls: _bgcommandClass.GenericAccessProfile,
                command: _bgcommandIDs.GAP_Connect_Direct
            }, paramCode: 0x44442a
        },
        gapEndProcedure: {
            header: {
                ...
                lolen: 0,
                cls: _bgcommandClass.GenericAccessProfile,
                command: _bgcommandIDs.GAP_End_Procedure
            }, paramCode: 0x00
        },
        gapConnectSelective: {
            header: {
                ...
                lolen: 8,
                cls: _bgcommandClass.GenericAccessProfile,
                command: _bgcommandIDs.GAP_Connect_Selective
            }, paramCode: 0x4444
        },
        gapSetFiltering: {
            header: {
                ...
                lolen: 3,
                cls: _bgcommandClass.GenericAccessProfile,
                command: _bgcommandIDs.GAP_Set_Filtering
            }, paramCode: 0x222
        },
        gapSetScanParameters: {
            header: {
                ...
                lolen: 5,
                cls: _bgcommandClass.GenericAccessProfile,
                command: _bgcommandIDs.GAP_Set_Scan_Parameters
            }, paramCode: 0x244
        },
        gapSetAdvParameters: {
            header: {
                ...
                lolen: 5,
                cls: _bgcommandClass.GenericAccessProfile,
                command: _bgcommandIDs.GAP_Set_Adv_Parameters
            }, paramCode: 0x244
        },
        gapSetAdvData: {
            header: {
                ...
                lolen: 2,
                cls: _bgcommandClass.GenericAccessProfile,
                command: _bgcommandIDs.GAP_Set_Adv_Data
            }, paramCode: 0x82
        },
        gapSetDirectedConnectable: {
            header: {
                ...
                lolen: 7,
                cls: _bgcommandClass.GenericAccessProfile,
                command: _bgcommandIDs.GAP_Set_Directed_Connectable_Mode
            }, paramCode: 0x2a
        },
        ...
        hwIOPortConfigIRQ: {
            header: {
                ...
                mType: _bgmessageType.Command,
                lolen: 3,
                cls: _bgcommandClass.Hardware,
                command: _bgcommandIDs.HW_IO_Port_Config_IRQ
            }, paramCode: 0x222
        },
        hwSetSoftTimer: {
            header: {
                ...
                lolen: 6,
                cls: _bgcommandClass.Hardware,
                command: _bgcommandIDs.HW_Set_Soft_Timer
            }, paramCode: 0x226
        },
        hwADCRead: {
            header: {
                ...
                lolen: 3,
                cls: _bgcommandClass.Hardware,
                command: _bgcommandIDs.HW_ADC_Read
            }, paramCode: 0x222
        },
        hwIOPortConfigDirection: {
            header: {
                ...
                lolen: 2,
                cls: _bgcommandClass.Hardware,
                command: _bgcommandIDs.HW_IO_Port_Config_Direction
            }, paramCode: 0x22
        },
        hwIOPortConfigFunction: {
            header: {
                ...
                lolen: 2,
                cls: _bgcommandClass.Hardware,
                command: _bgcommandIDs.HW_IO_Port_Config_Function
            }, paramCode: 0x22
        },
        hwIOPortConfigPull: {
            header: {
                ...
                lolen: 3,
                cls: _bgcommandClass.Hardware,
                command: _bgcommandIDs.HW_IO_Port_Config_Pull
            }, paramCode: 0x222
        },
        hwIOPortWrite: {
            header: {
                ...
                lolen: 3,
                cls: _bgcommandClass.Hardware,
                command: _bgcommandIDs.HW_IO_Port_Write
            }, paramCode: 0x222
        },
        hwIOPortRead: {
            header: {
                ...
                lolen: 2,
                cls: _bgcommandClass.Hardware,
                command: _bgcommandIDs.HW_IO_Port_Read
            }, paramCode: 0x22
        },
        hwSPIConfig: {
            header: {
                ...
                lolen: 6,
                cls: _bgcommandClass.Hardware,
                command: _bgcommandIDs.HW_SPI_Config
            }, paramCode: 0x222222
        },
        hwSPITransfer: {
            header: {
                ...
                lolen: 2,
                cls: _bgcommandClass.Hardware,
                command: _bgcommandIDs.HW_SPI_Transfer
            }, paramCode: 0x824
        },
        hwI2CRead: {
            header: {
                ...
                lolen: 3,
                cls: _bgcommandClass.Hardware,
                command: _bgcommandIDs.HW_I2C_Read
            }, paramCode: 0x222
        },
        hwI2CWrite: {
            header: {
                ...
                lolen: 3,
                cls: _bgcommandClass.Hardware,
                command: _bgcommandIDs.HW_I2C_Write
            }, paramCode: 0x822
        },
        hwSetTxPower: {
            header: {
                ...
                lolen: 1,
                cls: _bgcommandClass.Hardware,
                command: _bgcommandIDs.HW_Set_Tx_Power
            }, paramCode: 0x02
        },
        hwTimerComparator: {
            header: {
                ...
                lolen: 5,
                cls: _bgcommandClass.Hardware,
                command: _bgcommandIDs.HW_Timer_Comparator
            }, paramCode: 0x4222
        },
        ...
        testPhyTx: {
            header: {
                ...
                mType: _bgmessageType.Command,
                lolen: 3,
                cls: _bgcommandClass.Test,
                command: _bgcommandIDs.Test_Phy_Tx
            }, paramCode: 0x00
        },
        testPhyRx: {
            header: {
                ...
                lolen: 1,
                cls: _bgcommandClass.Test,
                command: _bgcommandIDs.Test_Phy_Rx
            }, paramCode: 0x00
        },
        testPhyEnd: {
            header: {
                ...
                lolen: 0,
                cls: _bgcommandClass.Test,
                command: _bgcommandIDs.Test_Phy_End
            }, paramCode: 0x04
        },
        testPhyReset: {
            header: {
                ...
                lolen: 0,
                cls: _bgcommandClass.Test,
                command: _bgcommandIDs.Test_Phy_Reset
            }, paramCode: 0x00
        },
        testGetChannelMap: {
            header: {
                ...
                lolen: 0,
                cls: _bgcommandClass.Test,
                command: _bgcommandIDs.Test_Get_Channel_Map
            }, paramCode: 0x08
        },
        testDebug: {
            header: {
                ...
                lolen: 1,
                cls: _bgcommandClass.Test,
                command: _bgcommandIDs.Test_Debug
            }, paramCode: 0x08
        },
        testgetChannelMode: {
            header: {
                ...
                lolen: 1,
                cls: _bgcommandClass.Test,
                command: _bgcommandIDs.Test_Channel_Mode
            }, paramCode: 0x00
        },
        ...
        dfuReset: {
            header: {
                ...
                mType: _bgmessageType.Command,
                lolen: 1,
                cls: _bgcommandClass.DFU,
                command: _bgcommandIDs.DFU_Reset
            }, paramCode: 0x02
        },
        dfuFlashSetAddress: {
            header: {
                ...
                lolen: 4,
                cls: _bgcommandClass.DFU,
                command: _bgcommandIDs.DFU_Flash_Set_Address
            }, paramCode: 0x06
        },
        dfuFlashUpload: {
            header: {
                ...
                lolen: 1,
                cls: _bgcommandClass.DFU,
                command: _bgcommandIDs.DFU_Flash_Upload
            }, paramCode: 0x08
        },
        dfuFlashUploadFinish: {
            header: {
                ...
                lolen: 0,
                cls: _bgcommandClass.DFU,
                command: _bgcommandIDs.DFU_Flash_Upload_Finish
            }, paramCode: 0x00
        },
    }
